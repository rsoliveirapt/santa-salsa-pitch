...
export function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0F0F0F] text-slate-100 flex flex-col font-sans">
      {/* Top Route Switcher Banner for Presenter Testing */}
      {showNav && (
            ...
            <div className="flex items-center gap-1 bg-[#1A1A1A] p-1 rounded-xl border-2 border-zinc-800">
              <button
                ...
                className={`px-3 py-1 rounded-lg font-bold transition-all flex items-center gap-1.5 ${
                  currentRoute === 'mobile'
                    ? 'bg-[#DC2626] text-white shadow-sm border border-amber-400'
              ...
              <button
                ...
                className={`px-3 py-1 rounded-lg font-bold transition-all flex items-center gap-1.5 ${
                  currentRoute === 'pitch'
                    ? 'bg-[#F59E0B] text-zinc-950 shadow-sm border border-zinc-950 font-black'
                    : 'text-zinc-400 hover:text-zinc-200'
                }`}
              >
